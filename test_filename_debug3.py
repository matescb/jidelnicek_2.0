...
"""
Debug filename sanitization with mocked settings.
"""
...
def test_sanitization():
    # Mock settings to allow .txt files
    with patch('jidelnicek.core.middleware.security.settings') as mock_settings:
        mock_settings.allowed_upload_extensions = [".txt", ".pdf", ".jpg", ".jpeg", ".png", ".gif", ".doc", ".docx"]
